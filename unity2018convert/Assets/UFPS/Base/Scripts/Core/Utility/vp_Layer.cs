...
public sealed class vp_Layer
{
	...
	public static class Mask
	{
		...
		public static int enemyBullet = (1 << LocalPlayer)| (1 << Default) | (1 << Water) | (1 << MovableObject | 1<< Enemy);
    ...
    static vp_Layer()
	{
		...
		Physics.IgnoreLayerCollision(Enemy, Enemy);		// player should never collide with small debris
