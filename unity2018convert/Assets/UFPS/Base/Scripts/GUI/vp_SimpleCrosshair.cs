...
public class vp_SimpleCrosshair : MonoBehaviour
{
	...
	// crosshair texture
	public Sprite m_ImageCrosshair = null;
	...
	void OnGUI()
	{
		...
		GUI.DrawTexture(new Rect((Screen.width * 0.5f) - (m_ImageCrosshair.texture.width * 0.5f),
			(Screen.height * 0.5f) - (m_ImageCrosshair.texture.height * 0.5f), m_ImageCrosshair.texture.width,
			m_ImageCrosshair.texture.height), m_ImageCrosshair.texture);
		GUI.color = Color.white;
	
	}
	
	
	protected virtual Sprite OnValue_Crosshair
	{
