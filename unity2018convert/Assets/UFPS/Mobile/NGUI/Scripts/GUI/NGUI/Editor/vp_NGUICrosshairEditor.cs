...
public class vp_NGUICrosshairEditor : vp_NGUIControlEditor
{
	...
	public override void OnInspectorGUI()
	{
		...
		m_Target.StartingTexture = (Sprite)EditorGUILayout.ObjectField("Crosshair", m_Target.StartingTexture, typeof(Sprite), false);
		m_Target.EnemyCrosshair = (Sprite)EditorGUILayout.ObjectField("Enemy Crosshair", m_Target.EnemyCrosshair, typeof(Sprite), true);
