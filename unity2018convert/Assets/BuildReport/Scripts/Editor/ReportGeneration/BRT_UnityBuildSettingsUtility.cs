...
//		settings.SamsungTVDeviceAddress = PlayerSettings.SamsungTV.deviceAddress;
	...
	public static void PopulateBigConsoleGen07Settings(UnityBuildSettings settings)
	{
		...
		settings.Xbox360RunMethod = EditorUserBuildSettings.xboxOneDeployMethod.ToString();
		...
		settings.SCEBuildSubtarget = EditorUserBuildSettings.androidBuildSubtarget.ToString();
#if UNITY_5
