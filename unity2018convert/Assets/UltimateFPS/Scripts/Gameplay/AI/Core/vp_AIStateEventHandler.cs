/////////////////////////////////////////////////////////////////////////////////
//
//	vp_AIStateEventHandler.cs
//	© VisionPunk. All Rights Reserved.
//	https://twitter.com/VisionPunk
//	http://www.visionpunk.com
//
//	description:	a version of vp_EventHandler that is aware of the vp_AIComponent
...
public abstract class vp_AIStateEventHandler : vp_EventHandler
{

	List<vp_AIComponent> m_StateTargets = new List<vp_AIComponent>();
	...
	protected override void Awake()
	{
		...
		// fetch all vp_AIComponents that exist at root level in the
		// same hierarchy as the event handler. these will be used to
		// block states recursively (down the hierarchy)
		foreach (vp_AIComponent c in transform.root.GetComponents<vp_AIComponent>())
		{
	...
	protected void BindStateToActivityOnStart(vp_Activity a)
	{
		...
		delegate()
		{
			foreach (vp_AIComponent c in m_StateTargets)
			{
	...
	public void RefreshActivityStates()
	{
		...
		foreach (vp_Event a in m_Events)
		{
